<%@ Page Language="C#" MasterPageFile="~/HomePageOne.master" AutoEventWireup="true" CodeFile="StyleContentFalse.aspx.cs" Inherits="SocialNetWorkingUpdata.StyleContentFalse" Title="悠悠社团网" %>
...
<div id="all">
    ...
    <asp:TextBox ID="TextBoxSk" 
        ...
        Height="97px" Width="372px" BorderStyle="None" Font-Size="Large" Font-Bold="True"></asp:TextBox></div>
    </div>
